  ...
  <div class="py-2 w-4/5 mx-auto">
      ...
      <div class="ml-6 flex flex-1 gap-x-3">
        ...
        <div class="relative w-full">
          ...
          <input 
              type="text" 
              name="search" 
              class="w-full rounded-md border border-soft-gray pl-10 py-2 text-sm" 
              placeholder="Search..." 
    ...
    <div class="mt-4 flex items-center justify-between">
      ...
      <div class="flex gap-x-8">
        ...
        <span onclick="window.location.href='{{ route('products.index') }}'"
              class="cursor-pointer rounded-sm py-1 px-2 text-sm font-medium hover:bg-medium-blue text-soft-gray">
            Sản phẩm
        </span>
