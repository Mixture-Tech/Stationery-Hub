...
@case('search')
<svg xmlns="http://www.w3.org/2000/svg" {{ $attributes }} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
@case('location')
<svg xmlns="http://www.w3.org/2000/svg" {{ $attributes }} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M12 2c3.87 0 7 3.13 7 7 0 5.25-7 13-7 13s-7-7.75-7-13c0-3.87 3.13-7 7-7z"></path>
    <circle cx="12" cy="9" r="2.5"></circle>
</svg>
@break

@case('menu-grid')
<svg width="24" height="24" viewBox="0 -0.5 21 21" xmlns="http://www.w3.org/2000/svg" fill="currentColor" {{ $attributes }}>
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="Dribbble-Light-Preview" transform="translate(-99.000000, -200.000000)" fill="currentColor">
...
@case('twitter-x')
<svg xmlns="http://www.w3.org/2000/svg" {{ $attributes }} viewBox="0 0 20 20" fill="none">
    <g id="Social Media">
...
@case('instagram')
<svg {{ $attributes }} viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
...
@case('linkedin')
<svg {{ $attributes }} viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
@case('youtube')
<svg {{ $attributes }} viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
@case('menu-grid-blue')
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-dark-blue">
...
@case('order')
<svg xmlns="http://www.w3.org/2000/svg" {{ $attributes }} viewBox="0 0 1024 1024" fill="currentColor">
    <path d="M300 462.4h424.8v48H300v-48zM300 673.6H560v48H300v-48z"></path>
    <path d="M818.4 981.6H205.6c-12.8 0-24.8-2.4-36.8-7.2-11.2-4.8-21.6-11.2-29.6-20-8.8-8.8-15.2-18.4-20-29.6-4.8-12-7.2-24-7.2-36.8V250.4c0-12.8 2.4-24.8 7.2-36.8 4.8-11.2 11.2-21.6 20-29.6 8.8-8.8 18.4-15.2 29.6-20 12-4.8 24-7.2 36.8-7.2h92.8v47.2H205.6c-25.6 0-47.2 20.8-47.2 47.2v637.6c0 25.6 20.8 47.2 47.2 47.2h612c25.6 0 47.2-20.8 47.2-47.2V250.4c0-25.6-20.8-47.2-47.2-47.2H725.6v-47.2h92.8c12.8 0 24.8 2.4 36.8 7.2 11.2 4.8 21.6 11.2 29.6 20 8.8 8.8 15.2 18.4 20 29.6 4.8 12 7.2 24 7.2 36.8v637.6c0 12.8-2.4 24.8-7.2 36.8-4.8 11.2-11.2 21.6-20 29.6-8.8 8.8-18.4 15.2-29.6 20-12 5.6-24 8-36.8 8z"></path>
    <path d="M747.2 297.6H276.8V144c0-32.8 26.4-59.2 59.2-59.2h60.8c21.6-43.2 66.4-71.2 116-71.2 49.6 0 94.4 28 116 71.2h60.8c32.8 0 59.2 26.4 59.2 59.2l-1.6 153.6z m-423.2-47.2h376.8V144c0-6.4-5.6-12-12-12H595.2l-5.6-16c-11.2-32.8-42.4-55.2-77.6-55.2-35.2 0-66.4 22.4-77.6 55.2l-5.6 16H335.2c-6.4 0-12 5.6-12 12v106.4z"></path>
</svg>
@break
