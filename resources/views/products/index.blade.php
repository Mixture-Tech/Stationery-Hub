                ...
                <div class="bg-white p-4 rounded shadow-sm">
                    ...
                    <form action="{{ route('products.index') }}" method="GET" id="price-filter-form">
                        ...
                        @if(request()->has('parent_category'))
                            <input type="hidden" name="parent_category" value="{{ request('parent_category') }}">
                        @endif
                        @if(request()->has('sort'))
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center">
                                <input type="checkbox" id="price-1" name="price[]" value="0-150" class="mr-2 price-checkbox"
                                    {{ in_array('0-150', (array)request('price')) ? 'checked' : '' }}>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" id="price-2" name="price[]" value="150-300" class="mr-2 price-checkbox"
                                    {{ in_array('150-300', (array)request('price')) ? 'checked' : '' }}>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" id="price-3" name="price[]" value="300-500" class="mr-2 price-checkbox"
                                    {{ in_array('300-500', (array)request('price')) ? 'checked' : '' }}>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" id="price-4" name="price[]" value="500-700" class="mr-2 price-checkbox"
                                    {{ in_array('500-700', (array)request('price')) ? 'checked' : '' }}>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" id="price-5" name="price[]" value="700-up" class="mr-2 price-checkbox"
                                    {{ in_array('700-up', (array)request('price')) ? 'checked' : '' }}>
                ...
                <div class="flex flex-col sm:flex-row items-center mb-4">
                    <div class="flex items-center mb-2 me-3 sm:mb-0">
                        ...
                        <div class="relative flex">
                            <select id="sort-select" class="form-select appearance-none block w-40 px-3 py-1.5 text-sm font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
                    ...
                    <div class="relative">
                        <select id="per-page-select" class="form-select w-32 text-sm appearance-none block px-3 py-1.5 font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
