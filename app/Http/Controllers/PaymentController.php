...
class PaymentController extends Controller
{
    ...
    public function processPayment(Request $request)
    {
        ...
        $request->validate([
            ...
            'payment_methods' => 'required|in:COD,momo,vnpay',
        ...
        Log::info('Chưa vào vnpay');
        // Xử lý thanh toán qua VNPay
        if ($request->payment_methods == 'vnpay') {
            $vnpayController = new VnpayPaymentController();
            Log::info('Đã vào VNPay');
            return $vnpayController->vnpayPayment($request, $total, $request->items);
        }
